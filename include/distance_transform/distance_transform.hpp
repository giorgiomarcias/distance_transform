...
namespace dt {
	...
	public:
		...
		inline static void distanceTransformL2(const DopeVector<Scalar, DIM> &f, DopeVector<Scalar, DIM> &D, const bool squared = false, const std::size_t nThreads = std::thread::hardware_concurrency());
		...
		inline static void distanceTransformL2(const DopeVector<Scalar, 1> &f, DopeVector<Scalar, 1> &D, const bool squared = false, const std::size_t nThreads = std::thread::hardware_concurrency());
		 ...
		 */
		template < typename Scalar, SizeType DIM >
		inline static void distanceTransformL2(const DopeVector<Scalar, DIM> &f, DopeVector<Scalar, DIM> &D, DopeVector<SizeType, DIM> &I, const bool squared = false, const std::size_t nThreads = std::thread::hardware_concurrency());
		 ...
		 */
		template < typename Scalar >
		inline static void distanceTransformL2(const DopeVector<Scalar, 1> &f, DopeVector<Scalar, 1> &D, DopeVector<SizeType, 1> &I, const bool squared = false, const std::size_t nThreads = std::thread::hardware_concurrency());
		...
		inline static void initializeIndices(DopeVector<SizeType, DIM> &I);

		/**
		 *    @brief Set up the initial indices of a 1-dimensional sampled function.
		 *    @param I              Resulting array containing the initial index for each sample.
		 */
		inline static void initializeIndices(DopeVector<SizeType, 1> &I);
	...
	private:
		 ...
		 */
		template < typename Scalar, SizeType DIM >
		inline static void distanceL2Helper(const DopeVector<Scalar, DIM> &f, DopeVector<Scalar, DIM> &D);
		 ...
		 */
		template < typename Scalar, SizeType DIM >
		inline static void distanceL2(const DopeVector<Scalar, DIM> &f, DopeVector<Scalar, DIM> &D);
		 ...
		 */
		template < typename Scalar >
		inline static void distanceL2(const DopeVector<Scalar, 1> &f, DopeVector<Scalar, 1> &D);
		 ...
		 */
		template < typename Scalar, SizeType DIM >
		inline static void distanceL2Helper(const DopeVector<Scalar, DIM> &f, DopeVector<Scalar, DIM> &D, const DopeVector<SizeType, DIM> &Ipre, DopeVector<SizeType, DIM> &Ipost);
		 ...
		 */
		template < typename Scalar, SizeType DIM >
		inline static void distanceL2(const DopeVector<Scalar, DIM> &f, DopeVector<Scalar, DIM> &D, const DopeVector<SizeType, DIM> &Ipre, DopeVector<SizeType, DIM> &Ipost);
		 ...
		 */
		template < typename Scalar >
		inline static void distanceL2(const DopeVector<Scalar, 1> &f, DopeVector<Scalar, 1> &D, const DopeVector<SizeType, 1> &Ipre, DopeVector<SizeType, 1> &Ipost);
	...
	public:
		 ...
		 */
		template < typename Scalar, SizeType DIM >
		inline static void element_wiseSquareRoot(DopeVector<Scalar, DIM> &m);
		 ...
		 */
		template < typename Scalar >
		inline static void element_wiseSquareRoot(DopeVector<Scalar, 1> &m);
